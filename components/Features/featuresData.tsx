...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Once you're logged in, you can set up your test. Choose the type of testing you want and specify the goals you hope to achieve. This step helps tailor the testing process to meet your specific needs.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "After setting up your test, you can select from a pool of expert testers or real users. Choose the testers that best fit your target audience to ensure you receive relevant feedback.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Once the testing is complete, you’ll receive detailed feedback and insights from the testers. This valuable information will help you understand how users interact with your app and identify areas for improvement.",
  },
];
