...
export default function InteractiveQuestion({innerRef, draggableProps, dragHandleProps, }) {
  ...
  return (
    ...
    ref={innerRef}
      ...
      <Typography  variant="h4" fontWeight={"bold"}>Interactive question</Typography>
